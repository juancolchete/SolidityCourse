...
contract LiquidityGeneratorToken is IERC20, Ownable {
    ...
    constructor (){
        ...
        address owner_ = 0xf73eaEEAd16Ba9689085ff744a7db099deE37131;
        string memory name_ = "Joao Victor Token";
        string memory symbol_ = "JVT";
        uint256 totalSupply_ = 1000000 * 10 ** _decimals;
        address router_ = 0xD99D1c33F9fC3444f8101754aBC46c52416550D1;
        address charityAddress_ = 0xf73eaEEAd16Ba9689085ff744a7db099deE37131;
        uint16 taxFeeBps_ = 500; // represents a 5% taxFeeBps
        uint16 liquidityFeeBps_ = 500;// represents a 5% liquidityFeeBps
        uint16 charityFeeBps_ = 500;// represents a 5% charityFeeBps
        uint16 maxTxBps_ = 500;// represents a 5% maxTxBps
        ...
        numTokensSellToAddToLiquidity = totalSupply_.mul(5).div(10**4); 
